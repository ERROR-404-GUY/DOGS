<div class="prose flex justify-center flex-col place-items-center items-center">
    <h1 class="m-5">Settings</h1>

<div class="flex justify-center items-center">
    <label class="cursor-pointer grid place-items-center inline-block">
        <input
            type="checkbox"
            value="night"
